import Emblem from "../../../../images/akitsudo.png"

const AkitsudanPettyKingdoms: any = [
]

export const AkitsudoList = [
    {
        "name": "Empire of Akitsudo",
        "fileName": "akitsudo",
        "tags": [
            "Akitsudo"
        ],
