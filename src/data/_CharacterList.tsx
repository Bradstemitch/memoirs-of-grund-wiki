...
import { CHARACTER_Core, NATION_Core, ORGANISATION_Core, SPECIES_Core } from "./__DATA_Core"
import { internalLink } from "../utils/common"
import { detailBuilder } from "../utils/builders"

function characterInfoBasic(alias: any, nationality: any, born: Number | null, status: string, death: Number | null) {
  return ({
    "basic": {
      "title": "Basic",
      "values": {
...
function characterInfoPhysical(species: any, gender: string, height: Number, hairColour: string, eyeColour: string, skinColour: string) {
  return ({
    "physical": {
      "title": "Physical",
      "values": {
...
function characterInfoPersonal(titles: string | string[] | null, professions: string | string[] | null, affiliations: any, skills: string | string[] | null) {
  return ({
    "personal": {
      "title": "Personal",
      "values": {
...
function characterInfoFamily(relatives: any, partner: any, children: any) {
  return ({
    "family": {
      "title": "Family",
      "values": {
...
export const CHARACTER_Info = {
  "ANEURIN": {
    ...characterInfoBasic(["Reaper", `"Icarus"`], NATION_Core.TUATHA_DE_DANANN, -34, "Stasis (9 BCE)", null),
    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.HUMAN, "Formerly"),
        detailBuilder(SPECIES_Core.HIGH_DRAGON, "Zyz")
      ],
      "Male", 1.88, "Brown", "Green", "White"
    ),
    ...characterInfoPersonal(["Reaper"], ["Reaper of Damocles"],
      [
        detailBuilder(ORGANISATION_Core.SWORDS_OF_DAMOCLES, "Formerly"),
        ORGANISATION_Core.SHARDS_OF_DAMOCLES,
      ],
      [
        "Master Tactician",
        "Swordsmanship",
    ...
    ...characterInfoFamily(
      [
        ...
        detailBuilder(CHARACTER_Core.SCATHACH, "Mentor"),
      ],
      [
      ],
      [
  ...
  "ELIJAH_SPENCER": {
    ...characterInfoBasic(["Doc", "Doctor"], "", null, "Deceased", null),
    ...characterInfoPhysical(SPECIES_Core.HUMAN,
    ...
    ...characterInfoPersonal(
      ...
      [
        detailBuilder(ORGANISATION_Core.VINDICTIS, "Formerly")
      ],
      [
        "Magic",
      ]
  ...
  "BARDR": {
    ...characterInfoBasic(["Exile"], "", -237, "Deceased", null),
    ...characterInfoPhysical(
      [
        "Dwarf"
      ],
  ...
  "ARLYSS_KNIGHT": {
    ...characterInfoBasic(["Reaper", `"Tac"`, "Knight"], "Terran", -24, "Deceased", -7),
    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.HUMAN, "Formerly"),
        detailBuilder(SPECIES_Core.HIGH_DRAGON, "Zyz")
    ...
    ...characterInfoPersonal(["Knight", "Reaper"], null,
      [
        detailBuilder(ORGANISATION_Core.SWORDS_OF_DAMOCLES, "Formerly"),
        ORGANISATION_Core.KNIGHT_COMMANDO,
        detailBuilder(ORGANISATION_Core.VINDICTIS, "Infiltration"),
      ],
      [
        "Master Tactician",
        "Swordsmanship",
    ...
    ...characterInfoFamily(
      ...
      [
        detailBuilder(CHARACTER_Core.LYRA_VITAE, "Wife"),
        detailBuilder("Eve", "Melded"),
      ],
      [
        detailBuilder("Essylt", "Scourge Imprint"),
        detailBuilder(CHARACTER_Core.LETA, "Daughter"),
        detailBuilder(CHARACTER_Core.LILITH_FAIRE, "Daughter in law"),
      ],),
  },
  "ARTHUR_PENDRAGON": {
    ...characterInfoBasic(["King Arthur", "Knight", "The Once and Future King"], NATION_Core.BRYTTH, null, "Statis (537 CE)", null),
    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.HUMAN, "Half-elf")
      ],
    ...
    ...characterInfoFamily(
      ...
      [
        detailBuilder(CHARACTER_Core.MORGAN_LE_FAY, "Lover"),
  ...
  "CERBERUS": {
    ...characterInfoBasic(["C3-R8"], detailBuilder("Terran", "Greek"), -37, "Alive", null),

    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.HUMAN, "Formerly"),
        detailBuilder(SPECIES_Core.VAMPIRE, "Progenitor"),
      ],
    ...
    ...characterInfoPersonal(
      ...
      [
        detailBuilder(ORGANISATION_Core.VINDICTIS, "Formerly"),
        ORGANISATION_Core.REMNANT,
        ORGANISATION_Core.LEGION,
        detailBuilder(ORGANISATION_Core.MESSAN_REBELLION, "Infiltration"),
      ],
      [
        "Master Tactician",
        "Swordsmanship",
  ...
  "DAG_INN_VAENI": {
    ...characterInfoBasic(["Dag Bothison"], detailBuilder(NATION_Core.KRASAHEIM, "Clan Knay"), null, "Alive", null), // clan knay needs adding
    ...
    ...characterInfoFamily(
      [
        detailBuilder("Unknown", "Father"),
        detailBuilder("Unknown", "Mother"),
        detailBuilder(CHARACTER_Core.NOTT_INN_RAUDI, "Sister"),
      ],
      [
  ...
  "LILITH_FAIRE": {
    ...characterInfoBasic(["Rhon’wyn"], NATION_Core.TUATHA_DE_DANANN, - 35, "Alive", null),
    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.ELF, "Sylvan")
      ]
    ...
    ...characterInfoPersonal(
      ...
      [
        detailBuilder(ORGANISATION_Core.VINDICTIS, "Formerly"),
        detailBuilder(ORGANISATION_Core.KNIGHT_COMMANDO, "Formerly"),
        ORGANISATION_Core.MESSAN_REBELLION
      ],
      [
        "Swordsmanship",
        "Archery",
  ...
  "LYRA_VITAE": {
    ...characterInfoBasic(["Song of Life", "Goddess of Life", "The Valkyrie"], "Terran", -46, "Alive", null),
    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.HIGH_DRAGON, "Silver")
      ],
      "Female", 1.79, "Silver", "Silver", "White"),
    ...characterInfoPersonal(["Captain", `"Vitae"`], "Military Officer",
      [
        detailBuilder(ORGANISATION_Core.VINDICTIS, "Formerly"),
        detailBuilder(ORGANISATION_Core.ZEALOTS, "Formerly"),
        detailBuilder(ORGANISATION_Core.KNIGHT_COMMANDO, "Infiltration"),
        ORGANISATION_Core.MESSAN_REBELLION,
      ],
      [
        "Strength",
    ...
    ...characterInfoFamily(
      [
        detailBuilder(CHARACTER_Core.MORRIGAN_MACHA, "mother"),
        detailBuilder("Unknown", "Father"),
      ],
      [
        detailBuilder(CHARACTER_Core.ARLYSS_KNIGHT, "Husband"),
      ],
      [
        detailBuilder(CHARACTER_Core.LETA, "Daughter"),
        detailBuilder(CHARACTER_Core.LILITH_FAIRE, "Daughter in law"),
  ...
  "NOTT_INN_RAUDI": {
    ...characterInfoBasic(["Nótt Bothidottir", `"Not" the Chosen-one`, "Ice-witch"], NATION_Core.KRASAHEIM, null, "Alive", null), // clan knay needs adding
    ...characterInfoPhysical(
      [
        SPECIES_Core.HUMAN
      ],
    ...
    ...characterInfoFamily(
      [
        detailBuilder("Unknown", "Father"),
        detailBuilder("Unknown", "Mother"),
        detailBuilder(CHARACTER_Core.DAG_INN_VAENI, "Brother"),
      ], null,
      [
  ...
  "THRESTROM": {
    ...characterInfoBasic([`"Is that a corpse?"`], NATION_Core.GOL, -143, "Deceased", -117),
    ...characterInfoPhysical(
      [
        detailBuilder(SPECIES_Core.HUMAN, "Gol")
      ],
...
*/
export const CHARACTER_ContentsSumary = {
  "ACHILLES": <div>
    <p>
  ...
  "LYRA_VITAE": <div>
    <p>
      <i>“I’ve met our ‘mortal enemies’, spoke with them, laughed with them and fought beside them. I have watched them throw themselves in front of arrows to be a shield for terrified civilians, I have watched them mourn their fallen and toast, not to valour or bloodshed, but to lives saved. Why then do we fight them? Are we not the same?”</i>- Lyra, reporting to {internalLink("Oberon", CHARACTER_Core.OBERON_VALERIAN)} after {internalLink(`Lilith"s`, CHARACTER_Core.LILITH_FAIRE)} last stand </p>
    <p>
      Lyra, born on Earth prior to its destruction, is a silver High Dragon who participated in several world changing events. For the majority of her military career, she was a tenacious nemesis of {internalLink("Arlyss Knight", CHARACTER_Core.ARLYSS_KNIGHT)} whom she later married. Shortly prior to his death, their daughter {internalLink("Leta", CHARACTER_Core.LETA)} was born, however {internalLink("Arlyss", CHARACTER_Core.ARLYSS_KNIGHT)} never knew about her and Lyra was forced to raise {internalLink("Leta", CHARACTER_Core.LETA)} alone until her disappearance.
    </p>
    <p>
      During her time as an active Vindictis captain, Lyra led one of their most prestigious units the Zealots as they sought to unite the fragmented nations behind a single banner where Lyra’s near mythical ability for healing would unintentionally result in recklessness and steady loss of sensation, affecting even their descendants many centuries later. She was often involved and a victim of espionage and counter-espionage operations, culminating in Lyra accidentally leading the recovery and rehabilitation of {internalLink("Arlyss", CHARACTER_Core.ARLYSS_KNIGHT)} after his violent reaction to the ‘Knight Elixir’. Lyra firmly agreed with the goals of the Vindictis until she eventually cut all ties after their assassination of {internalLink("Arlyss", CHARACTER_Core.ARLYSS_KNIGHT)} and attempted assassination of herself.
    </p>
    <p>
      Lyra would eventually go on to join up with the Messan Rebellion several centuries later, where she used her powers again as a field medic, however her combat prowess left her the powerhouse of the 5th Outrider’s  and a Staunch ally to {internalLink("Lilith", CHARACTER_Core.LILITH_FAIRE)}, when asked why she would only ever say “I made a promise”.
    </p>
  </div>,
  "MEDEA": <div>
    <p>
...
export const CHARACTER_ContentsAppearance = {
  "ARLYSS_KNIGHT": <div>
...
export const CHARACTER_ContentsPersonality = {
  "ARLYSS_KNIGHT": <div>
...
export const CHARACTER_ContentsRelationships = {
  "ELIJAH_SPENCER": <div>
    Brother -
...
export const CHARACTER_ContentsHistory = {
  "ANEURIN": <div>
    <p>
      Early Life
      The Mists - (29 BCE)
...
export const CHARACTER_ContentsTrivia = {
  "ANEURIN": <div>
    <p>
...
export function characterBuilder(name: string) {
  return ({
    ...
    "summary": CHARACTER_ContentsSumary[name],
    "appearance": CHARACTER_ContentsAppearance[name],
    "personality": CHARACTER_ContentsPersonality[name],
    "relationships": CHARACTER_ContentsRelationships[name],
    "history": CHARACTER_ContentsHistory[name],
    "trivia": CHARACTER_ContentsTrivia[name],
  })
}
