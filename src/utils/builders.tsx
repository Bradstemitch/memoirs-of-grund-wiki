...
export function coreCharacterBuilder(forname: string, surname: string, tags: string[], imageLoc: string, pronunciation: string) {
    const nameObj = {
        'fore': forname,
        'sur': surname,
    }
    return coreBuilder(nameObj, (forname + surname).replace(/\s/g, ""), 'characters', imageLoc, pronunciation, tags)
}
