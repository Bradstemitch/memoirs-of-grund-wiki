import { arm_heavyLeathers, arm_hiveLeathers } from "../Items/arm-basic"
import { arm_guardFlakArmour, arm_lightBrassArmour } from "../Items/arm-flak"
import { wep_fireBomb, wep_fragGrenade, wep_krakGrenade } from "../Items/explosives"
import { wep_chainaxe, wep_chainsword, wep_eviscerator } from "../Items/meleeWep-chain"
import { wep_axe, wep_knife_mel, wep_knife_throw, wep_spear, wep_sword } from "../Items/meleeWep-lowTech"
import { wep_heavyChainCleaver, wep_needlePistol, wep_neuroGauntlet } from "../Items/wep-exotic"
import { wep_exterminator, wep_flamer } from "../Items/rangedWep-flamer"
import { wep_hotShotLasgun, wep_lasgun, wep_laspistol } from "../Items/rangedWep-las"
import { wep_grenadeLauncher } from "../Items/rangedWep-launcher"
import { wep_autogun, wep_shotgun, wep_stubAutomatic, wep_stubCannon } from "../Items/rangedWep-solidProjectile"
import { Rings } from "../Token/TokenRing"
import { talent_adamantiumFaith, talent_ambidextrous, talent_battleRage, talent_blademaster, talent_bulgingBiceps, talent_combatMaster, talent_constantVigilance, talent_counterAttack, talent_crushingBlow, talent_deathDealer, talent_devastaingAssault, talent_divineProtection, talent_hardTarget, talent_hardy, talent_inescapableAttack, talent_ironJaw, talent_leapUp, talent_lightningAttack, talent_mightyShot, talent_preternaturalSpeed, talent_rapidReload, talent_stepAside, talent_swiftAttack, talent_technicalKnock, talent_templeAssassin, talent_trueGrit, talent_twoWeaponMaster, talent_twoWeaponWielder, talent_unarmedSpecialist, trait_frenzy } from "../Traits/Talents"
import { NPCStats } from "../DH2eDefault"
import { NPCCharacteristics } from "./00DHStats"
import { trait_autoStabilised, trait_darkSight, trait_fear, trait_fromBeyond, trait_machine, trait_multipleArms, trait_naturalArmour, trait_naturalWeaponsDeadly, trait_undying, trait_unnaturalAgility, trait_unnaturalStrength, trait_unnaturalToughness } from "../Traits/Traits"
import { wep_shockWhip } from "../Items/meleeWep-shock"
import { wep_boltgun, wep_heavyBolter } from "../Items/rangedWep-bolt"
import { arm_enforcerCarapace, arm_tempestusCarapace } from "../Items/arm-carapace"
import { wep_powerFist } from "../Items/meleeWep-power"
import { cyb_subskinArmour } from "../Items/cybernetics"
import { wep_rendingClaws } from "../Items/wep-tyranid"
import { arm_flakk, wep_ork_choppa, wep_ork_powerKlaw, wep_ork_rokkit, wep_ork_scopedBigShoota, wep_ork_shootaTwinLinked, wep_ork_slugga } from "../Items/wep-ork"
import { machine } from "os"
import { wep_tunnellingClawsMelee, wep_tunnellingClawsRanged } from "../Items/wep-brute"
import { equip_eversorCombatDrugs } from "../Items/equipment"
import { wep_plasmaPistol } from "../Items/rangedWep-plasma"

export function DarkHeresyNPC(factionProp: string, nameProp: string, weaponProp: string, threatProp: number, rank?: string) {
    ...
    const gangConst = faction.toLowerCase()
    systemData.system.characteristics.weaponSkill.base = NPCCharacteristics[gangConst][name.toLowerCase()][0]
    systemData.system.characteristics.ballisticSkill.base = NPCCharacteristics[gangConst][name.toLowerCase()][1]
    systemData.system.characteristics.strength.base = NPCCharacteristics[gangConst][name.toLowerCase()][2]
    systemData.system.characteristics.toughness.base = NPCCharacteristics[gangConst][name.toLowerCase()][3]
    systemData.system.characteristics.agility.base = NPCCharacteristics[gangConst][name.toLowerCase()][4]
    systemData.system.characteristics.intelligence.base = NPCCharacteristics[gangConst][name.toLowerCase()][5]
    systemData.system.characteristics.perception.base = NPCCharacteristics[gangConst][name.toLowerCase()][6]
    systemData.system.characteristics.willpower.base = NPCCharacteristics[gangConst][name.toLowerCase()][7]
    systemData.system.characteristics.fellowship.base = NPCCharacteristics[gangConst][name.toLowerCase()][8]
    systemData.system.characteristics.influence.base = NPCCharacteristics[gangConst][name.toLowerCase()][9]
    systemData.system.wounds.max = NPCCharacteristics[gangConst][name.toLowerCase()][10]
    systemData.system.wounds.value = NPCCharacteristics[gangConst][name.toLowerCase()][10]
    ...
    return {
        ...
        "name": `${nameProp} ${weapon && ("w/ " + weapon + " ")}(${threat})`,
        "type": "npc",
        "img": "modules/40k-rpg-addons/assets/portraits/" + imageLoc,
        ...systemData,
        ...Rings(ringRank || "Troop", name, "modules/40k-rpg-addons/assets/tokens/" + imageWild, size),
        "items": [
            ...weapons,
            ...armour,
            ...equipment,
